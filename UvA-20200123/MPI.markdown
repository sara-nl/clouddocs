...
# UvA HPC course 2020-01-23  <br/> Extras - Wave simulation with MPI
...
source ~/.bashrc
wget https://raw.githubusercontent.com/sara-nl/clouddocs/gh-pages/UvA-20200123/code/policy.xml
...
```sh
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20200123/code/waveeq2.tar.gz 
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20200123/code/makeme_master.sh
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20200123/code/makeme_worker.sh
