...
<i class="fa fa-bookmark-o fa-2x" aria-hidden="true"></i> 
<span style="color:red;">Images not rendered!</span> The HPC Cloud documentation images are not being rendered correctly. The service team is fixing the issue.
</div>
</div>
