...
# Good practices for HPC and Cloud 2019-05-23 <br/> Part B
...
This is part B of the tutorial [Good practices for HPC and Cloud 2019-05-23](.) and covers the following topics:
...
* i. Making your image persistent.
* ii. Starting a VM using the persistent image.
* iii. Shutting down once you are done.
...
* i. Editing your `template`.
* ii. Re-instantiating a VM from the modified `template`.
* iii. Shuting down once you are done.
...
#### ii. Instantiating the four-core VM
...
#### iii. Shutting down the four-core VM

It is important to release resources you are not using.
...
* i. Creating a new empty `image` for bulk data
* ii. Adding the new `image` to the `template`
* iii. Mounting the `image` in the VM
* iv. Shutting down once you are done
...
You can now _terminate_ your VMs.
...
### Next: part C
You completed part A of the Tutorial [Good practices for HPC and Cloud 2019-05-23](.). Please continue with Tutorial [Part C](partC).
