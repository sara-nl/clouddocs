...
# Good practices for HPC and Cloud 2019-05-23 <br/> Part C
...
This is part C of the tutorial [Good practices for HPC and Cloud 2019-05-23](.) and covers the following topics:
...
### Next: Extras
You have completed part C of the Tutorial [Good practices for HPC and Cloud 2019-05-23](.). If you want more of the HPC Cloud proceed to the [Extras part](extras).
