...
# Good practices for HPC and Cloud 2019-05-23 <br/> Part A
...
This is part A of the tutorial [Good practices for HPC and Cloud 2019-05-23](.) and covers the following topics:
...
The interface supports several so-called _views_ and for this course, you should use the _**user** view_.
...
### Next: part B
You completed part A of the Tutorial [Good practices for HPC and Cloud 2019-05-23](.). Please continue with Tutorial [Part B](partB).
