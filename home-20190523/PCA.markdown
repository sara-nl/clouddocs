...
# Good practices for HPC and Cloud 2019-05-23  <br/> Extras - Principal Component Analysis (PCA)
...
```sh
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/home-20190523/code/airplane-delay.tar 
