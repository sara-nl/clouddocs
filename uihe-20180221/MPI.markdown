...
# IHE Delft course 2018-02-21  <br/> Extras - Wave simulation with MPI
...
This is an exercise from the [Extras](extras) part of the Tutorial [IHE Delft course 2018-02-21](.).
...
```sh
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/uihe-20180221/code/waveeq.tar.gz 
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/uihe-20180221/code/makeme_master.sh
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/uihe-20180221/code/makeme_worker.sh
