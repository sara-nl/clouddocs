...
This is part B of the tutorial [UvA HPC course 2019-01-30](.) and covers the following topics:
...
### Next: part C
You completed part A of the Tutorial [UvA HPC course 2019-01-30](.). Please continue with Tutorial [Part C](partC).
