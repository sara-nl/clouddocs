...
# HPC Cloud tutorials<br/> Extras - Wave simulation with MPI

<div style="float:right;max-width:205px;" markdown="1">
![SURFsara logo](/images/SURFsara_logo.png)
</div>

This is an exercise from the [Extras](extras) part of the [HPC Cloud tutorials](.).
...
* On the UI, import a new Ubuntu `App`:
  * On the _<i class="fa fa-cloud-download"></i> Apps_ tab (under _Storage_), import another copy of the **Ubuntu-18.04-Desktop ** `app`. Make sure you select the proper datastore for your new OS image. Give the `image` and `template` the name: **mpi_wave**
...
```sh
wget https://doc.hpccloud.surfsara.nl/tutorials/code/waveeq.tar.gz 
...
```sh
cd
wget https://doc.hpccloud.surfsara.nl/tutorials/code/makeme_master.sh
...
```sh
cd
wget https://doc.hpccloud.surfsara.nl/tutorials/code/makeme_worker.sh
