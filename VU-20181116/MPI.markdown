...
# VU HPC course 2018-11-16  <br/> Extras - Wave simulation with MPI
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/VU-20181116/code/makeme_master.sh
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/VU-20181116/code/makeme_worker.sh
