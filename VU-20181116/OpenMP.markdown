...
# VU HPC course 2018-11-16  <br/> Extras - Calculating _&pi;_ with OpenMP
...
This is an exercise from the [Extras](extras) part of the Tutorial [VU HPC course 2018-11-16](.).
...
* On the UI, create a 2-core `template` that will use your existing **First Image**:
  ...
  * Edit the _<i class="fa fa-laptop"></i> General_ tab: 
    ...
    * and **2 VCPUs**
    * type in **4GB Memory** 
  * Edit the _<i class="fa fa-tasks"></i> Storage_ tab: for the _Disk 0_, choose the **First Image** (from the table on the right of the screen)
  * Edit the _<i class="fa fa-globe"></i> Network_ tab: for the _NIC 0_, choose the _Internet network_.  
  * Edit the _<i class="fa fa-power-off"></i> OS Booting_ tab, under _Features_:
    * choose _Acpi_: yes
...
```sh
wget http://doc.hpccloud.surfsara.nl/VU-20181116/code/gridpi-mp.tar 
