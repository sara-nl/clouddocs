...
# VU HPC course 2018-11-16 <br/> Part A
...
This is part A of the tutorial [VU HPC course 2018-11-16](.) and covers the following topics:
...
* Click on the _<i class="fa fa-share"></i> OpenNebula_ button at the top of the screen
...
### Next: part B
You completed part A of the Tutorial [VU HPC course 2018-11-16](.). Awesome! Before proceeding with [Part B](partB), please carefully read the following:
