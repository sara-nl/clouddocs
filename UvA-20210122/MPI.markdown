...
# UvA HPC course 2021-01-22  <br/> Extras - Wave simulation with MPI
...
source ~/.bashrc
wget https://raw.githubusercontent.com/sara-nl/clouddocs/gh-pages/UvA-20210122/code/policy.xml
...
```sh
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20210122/code/waveeq2.tar.gz 
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20210122/code/makeme_master.sh
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20210122/code/makeme_worker.sh
