...
* If you follow these tutorials as part of an (introduction) course, your instructor will have credentials ready for you to use. Otherwise, you will need to use your own credentials. See [our website](https://userinfo.surfsara.nl/systems/hpc-cloud/obtaining-account) on how to obtain an account if you have none.
...
* A dialogue will pop up asking you for a few details. Edit as follows:
  ...
  * Below "Select the Datastore to store the resource", depending on what is available, select **147: _Courses\_img_**, **164: _Courses2\_imgages_** or **104: _local\_images\_ssd_**
...
### Next: part B
You completed part A of the [HPC Cloud tutorials](.). Please continue with Tutorial [Part B](partB).
