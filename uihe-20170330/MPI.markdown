...
# UNESCO-IHE symposium 2017-03-30&31  <br/> Extras - Wave simulation with MPI
...
```sh
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/uihe-20170330/code/waveeq.tar.gz 
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/uihe-20170330/code/makeme_master.sh
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/uihe-20170330/code/makeme_worker.sh
