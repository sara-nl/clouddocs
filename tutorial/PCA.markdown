...
# HPC Cloud Tutorial  <br/> Extras - Principal Component Analysis (PCA)
...
This is an exercise from the [Extras](extras) part of the [HPC Cloud Tutorial](.).
...
```sh
wget http://doc.hpccloud.surfsara.nl/tutorial/code/airplane-delay.tar 
