...
This is part A of the Tutorial [VU course 2016-10-19](.).
...
* Your username is **s-landXZ**, replace `XZ` with the number assigned to you.
...
### Next: part B
Now that you completed part A of the Tutorial [VU course 2016-10-19](.). Please continue with Tutorial [Part B](partB).
