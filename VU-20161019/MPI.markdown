...
# VU course 2016-10-19  <br/> Extras - Wave simulation with MPI
...
```sh
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/VU-20161019/code/waveeq.tar.gz 
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/VU-20161019/code/makeme_master.sh
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/VU-20161019/code/makeme_worker.sh
