...
# UvA HPC course 2017-07-03  <br/> Extras - Wave simulation with MPI
...
```sh
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20170703/code/cloudinit_fix.sh
...
```sh
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20170703/code/waveeq.tar.gz 
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20170703/code/makeme_master.sh
...
```sh
cd
wget https://github.com/sara-nl/clouddocs/raw/gh-pages/UvA-20170703/code/makeme_worker.sh
