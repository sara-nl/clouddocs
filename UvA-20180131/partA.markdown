...
# UvA HPC course 2018-01-31 <br/> Part A
...
This is part A of the tutorial [UvA HPC course 2018-01-31](.) and covers the following topics:
...
### Next: part B
You completed part A of the Tutorial [UvA HPC course 2018-01-31](.). Please continue with Tutorial [Part B](partB).
